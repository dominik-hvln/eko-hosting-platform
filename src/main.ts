...
async function bootstrap() {
    ...
    try {
        ...
        if (fs.existsSync(keyPath) && fs.existsSync(certPath)) {
            ...
            console.log('Certyfikaty SSL załadowane. Uruchamianie serwera w trybie HTTPS.');
        } else {
            console.log('Nie znaleziono certyfikatów SSL w folderze /ssl. Uruchamianie serwera w standardowym trybie HTTP.');
        }
    } catch (err) {
